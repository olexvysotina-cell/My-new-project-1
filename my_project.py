...
st.set_page_config(page_title="Коливання цін на харчові продукти",
                   page_icon = r"D:\2-12\Vysotina_Oleksandra\python_projects\st,small,507x507-pad,600x600,f8f8f8.jpg",
                   layout= "wide")
df = pd.read_excel(r"D:\2-12\Vysotina_Oleksandra\python_projects\products_change.xlsx")
Image = Image.open(r"d:\2-12\Vysotina_Oleksandra\python_projects\st,small,507x507-pad,600x600,f8f8f8.jpg")
